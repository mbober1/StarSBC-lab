...
if mmc dev 1; then
    ...
    load mmc 1:${boot_part} ${loadaddr} /boot/${image}
    load mmc 1:${boot_part} ${fdt_addr} /boot/starsbc-6ull.dtb
    setenv bootargs ${jh_clk} ${mcore_clk} console=${console},115200 root=${mmcroot}
